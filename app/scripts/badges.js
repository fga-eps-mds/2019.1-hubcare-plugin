...
export default (colorPercent) => [
	...
	'<div id="percent"><p class="text2"></p>',
    '</div><p class="text1"></p></div>',
    '<div class="badges" id="my-badge2"><div id="percent"><p class="text2"></p>',
    '</div><p class="text1"></p></div>',
    '<div class="badges" id="my-badge3"><div id="percent"><p class="text2"></p>',
    '</div><p class="text1"></p></div>',
].join('');
